...
Com isso terminamos o nosso primeiro projeto com testes unitários, cobrindo todos os nossos possíveis cenários, mas caso queira fazer download ou fork do código final, acesse o [repositório do projeto fire alarm no Github](https://github.com/willmendesneto/fire-alarm). No próximo capítulo veremos outros serviços que facilitam a nossa vida ao enviarmos o código para produção, tais como servidores de integração contínua, cobertura de código e de complexidade de maneira automatizada.
